...
def decorator(func):
    def wrapper(*args, **kwargs):
        start = time.perf_counter()    # زمان شروع
        result = func(*args, **kwargs) # اجرای تابع
        end = time.perf_counter()      # زمان پایان
        
        print("زمان اجرا:", end - start, "ثانیه")
        return result                  # برگرداندن خروجی تابع
    return wrapper
